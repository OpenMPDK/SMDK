...
static bwd_loglevel log_level = SYSLOG_LEVEL_INFO;
...
static void bwdlogv(bwd_loglevel level, const char *fmt, va_list args)
{
	...
	if (log_is_on_stderr())
		...
		openlog("bwd", LOG_PID, LOG_DAEMON);
