...
#ifdef CONFIG_EXMEM
# define IF_HAVE_GFP_EXMEM(flag) ,gfpflag_string(flag)
# define IF_HAVE_GFP_NOEXMEM(flag) ,gfpflag_string(flag)
#else
# define IF_HAVE_GFP_EXMEM(flag)
# define IF_HAVE_GFP_NOEXMEM(flag)
#endif
...
IF_HAVE_GFP_EXMEM(__GFP_EXMEM)	\
IF_HAVE_GFP_NOEXMEM(__GFP_NOEXMEM)	\
