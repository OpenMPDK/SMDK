...
#  2) SMDK allcator, tierd are built.
#  3) tierd.conf is modified accordingly.
###################################################################
...
testcase=()
testcase+=("tierd/run_tierd_allocator_test.sh")
testcase+=("tierd/run_tierd_daemon_test.sh")
testcase+=("tierd/run_tierd_driver_test.sh")
testcase+=("tierd/run_tierd_plugin_test.sh")
