...
static struct cxl_mem_command cxl_mem_commands[CXL_MEM_COMMAND_ID_MAX] = {
	...
	CXL_CMD(GET_TIMESTAMP, 0, 0x08, 0),
	CXL_CMD(SET_TIMESTAMP, 0x08, 0, 0),
	CXL_CMD(GET_EVENT_RECORD, 0x01, CXL_VARIABLE_PAYLOAD, 0),
	CXL_CMD(CLEAR_EVENT_RECORD, CXL_VARIABLE_PAYLOAD, 0, 0),
	CXL_CMD(TRANSFER_FW, CXL_VARIABLE_PAYLOAD, 0, 0),
	CXL_CMD(ACTIVATE_FW, 0x02, 0, 0),
	CXL_CMD(SANITIZE, 0, 0, 0),
	CXL_CMD(GET_SLD_QOS_CONTROL, 0, 0x4, 0),
	CXL_CMD(SET_SLD_QOS_CONTROL, 0x4, 0, 0),
	CXL_CMD(GET_SLD_QOS_STATUS,  0, 0x1, 0),
};
